...
test( 'Basic Verify how to Handle Web Tables', async ( { page } ) => {

    // First of all, go to the link of web tables,
    // find the correct Helen Bennett, and then 
    // use a for loop to find the following simple

    await page.goto( "https://awesomeqa.com/webtable.html" );

    // table[@id="customers"]/tbody/tr[5]/td[2]

    // 5-i, 1 to 7 (1 is header) then we go from 2 to 7
    // ]/td[
    //2-j, j-> 1,2,3
    //]
