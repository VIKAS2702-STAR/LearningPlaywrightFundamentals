...
- Name: 06_Multiple_Elements\266_Task_Student_Login.spec.ts >> Automate Student Login
- Location: tests\06_Multiple_Elements\266_Task_Student_Login.spec.ts:3:5
...
Expected: "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=prajapativikas269%40gmail.com&password=Devansh%402702&remember=yes#login-success"
Received: "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=prajapativikas269%40gamil.com&password=Devansh%402702&remember=yes#login-success"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    12 × locator resolved to <html lang="en" data-theme="light">…</html>
       - unexpected value "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=prajapativikas269%40gamil.com&password=Devansh%402702&remember=yes#login-success"
...
```ts
  ...
  2  | 
  3  | test( 'Automate Student Login', async ( { page } ) => {
  4  |     await page.goto( 'https://app.thetestingacademy.com/playwright/multiple_element_filter' );
  5  | 
  6  |     //Locating the email and password input fields
  7  |     const email = page.locator( '#email' );
  8  |     const password = page.locator( '#password' );
  9  |     const expectedURL = "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=prajapativikas269%40gmail.com&password=Devansh%402702&remember=yes#login-success";
  10 | 
  11 |     await email.fill( "prajapativikas269@gamil.com" );
  12 |     await password.fill( "Devansh@2702" );
  13 |     await page.getByRole( 'checkbox', { name: 'remember' } ).check();
  14 |     await page.getByTestId( 'login-button' ).click();
> 15 |     await expect( page ).toHaveURL( expectedURL );
     |                          ^ Error: expect(page).toHaveURL(expected) failed
  16 | 
  17 | } );
```