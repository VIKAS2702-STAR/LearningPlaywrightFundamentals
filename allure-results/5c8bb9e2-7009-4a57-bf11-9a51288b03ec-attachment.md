...
```
Error: locator.textContent: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//div[contains(@class,'invalid-readon')' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//div[contains(@class,\'invalid-readon\')').first()
